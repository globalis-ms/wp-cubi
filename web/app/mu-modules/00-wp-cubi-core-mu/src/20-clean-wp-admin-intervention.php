...
// Read full documenation on https://github.com/soberwp/intervention
...
return [
    ...
    //     ],
         'discussion' => WP_CUBI_ENABLE_COMMENTS,
    //     'discussion' => [
    ...
    //  ],
        'common' => [
            'adminbar' => [
                'wp',
                // 'wp.[about, documentation, support, feedback]',
                'updates',
                'site' => [
                    // 'menu',
                    // 'visit',
